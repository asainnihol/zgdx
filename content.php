...
<html xmlns:wormhole="http://www.w3.org/1999/xhtml" lang="id-ID">
    <head>
        ...
        <meta name="author" content="<?php echo $bigBrand ?>">
        ...
        <meta name="og:site_name" content="<?php echo $bigBrand ?>" />
        <meta name="og:title" content="<?php echo $baseTitle ?>" />
        <meta name="og:type" content="product" />
        <meta name="og:description" content="<?php echo $baseDesc ?>" />
        <meta property="article:tag" content="<?php echo $bigBrand ?>" />
        <meta property="article:tag" content="<?php echo $bigBrand ?> HARI INI" />
        <meta property="article:tag" content="<?php echo $bigBrand ?> MALAM INI" />
        <meta property="article:tag" content="<?php echo $bigBrand ?> BET 200 PERAK" />
        <meta property="article:tag" content="<?php echo $bigBrand ?> ALTERNATIF" />
        <meta property="article:tag" content="<?php echo $bigBrand ?>" />
        <meta name="geo.position" content="-0.789275;113.921327">
        <meta name="geo.placename" content="Indonesia">
        <meta name="geo.region" content="ID"></meta>
        <meta name="og:image" content="<?php echo $baseImages ?>" />
        <link rel="manifest" href="https://g.lazcdn.com/g/lzdfe/pwa-assets/5.0.7/manifest/id.json" />
        <link rel="shortcut icon" href="<?php echo $baseFavIcon ?>" />
        <link rel="canonical" href="<?php echo $baseURL ?>" />
        <link rel="amphtml" href="<?php echo $ampURL ?>" />
        <link rel="preload" href="<?php echo $ampURL ?>" as="amphtml" />
        <!-- start preload -->
        <link rel="preload" href="<?php echo $baseImages ?>" as="image" />
        ...
        <script type="application/ld+json">
            {
                ...
                "name": "<?php echo $baseTitle ?>",
                "image": "<?php echo $baseImages ?>",
                "category": "Televisi & Video",
                "brand": { "@type": "Brand", "name": "SLOT GACOR", "url": "<?php echo $baseURL ?>" },
                "sku": "3642482616_ID-6108584955",
                "mpn": 3642482616,
                "description": "<?php echo $baseDesc ?>",
                            ...
                            <div class="lzd-links-bar" id="topActionLinks">
                                <div class="links-list header-content ID id">
                                    <div class="top-links-item" id="topActionInternalFeedback" style="display: none;">
                                        <a class="highlight" target="_blank" href="<?php echo $baseURL ?>" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d0">INTERNAL FEEDBACK</a>
                                    </div>
                                    <div class="top-links-item" id="topActionFeedback">
                                        <a target="_blank" href="<?php echo $baseURL ?>" data-spm-click="gostr=/lzdpub.header.tbar;locaid=dfeedback"><?php echo $bigBrand ?></a>
                                    </div>
                                    <div class="top-links-item orange" id="topActionDownload" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d1">
                                        <span><a href="<?php echo $baseURL ?>"><?php echo $bigBrand ?> LOGIN</a></span>
...
//]]></script> -->
                                    ...
                                    <div class="top-links-item" id="topActionSell">
                                        <a class="black" href="<?php echo $baseURL ?>"><?php echo $bigBrand ?> LINK ALTERNATIF</a>
                                    </div>
                                    <div class="top-links-item" id="topActionCustomCare" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d3">
                                        <span><a href="<?php echo $baseURL ?>">RTP <?php echo $bigBrand ?></a></span>
                                    ...
                                    <div class="top-links-item" id="topActionTrack" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d4">
                                        <span><a href="<?php echo $baseURL ?>"> LINK <?php echo $bigBrand ?></a></span>
                                        <div class="lzd-track-popup top-popup-wrap" id="lzdTrackPop">
                                            <div class="top-popup-content lzd-track-content">
                                                <div id="topActionMyLastOrder"></div>
                                                <div class="track-title"><?php echo $bigBrand ?></div>
                                    ...
                                    <div class="top-links-item" id="anonLogin">
                                        <a href="<?php echo $ampURL ?>" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d5" style="color: #000000;">LOGIN</a>
                                    </div>
                                    <div class="top-links-item grey" id="anonSignup">
                                        <a href="<?php echo $ampURL ?>" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d6" style="color: #000000;">DAFTAR</a>
                                    </div>
                            ...
                            <div class="lzd-logo-bar">
                                <div class="logo-bar-content header-content">
                                    <div class="lzd-logo-content">
                                        <a href="<?php echo $baseURL ?>" data-spm="dhome">
                                            <img
                                                src="https://nerlamina.sirv.com/image-bvs/logo-slot-gacor-bolavitaslot.png"
                                                alt="<?php echo $bigBrand ?>"
                                                style="object-fit: contain; width: 80%; height: auto;"
                                            />
                                        </a>
                                    </div>
                                    <div class="lzd-nav-search" data-spm="search">
                                        <input type="text" class="input-search" placeholder="CARI DI <?php echo $bigBrand ?>">
                                                ...
                                                <div class="lzd-site-menu-nav-container">
                                                    ...
                                                    <nav class="lzd-menu-labels" data-spm="menu">
                                                        ...
                                                        >
                                                            <span class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon">
                                                                <img
                                                                    ...
                                                                    src="https://nerlamina.sirv.com/image-bvs/favicon-bvs.png"
                                                                />
                                                            </span>
                                                            <!--<i class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon lazada-ic-channel-LazMall">&#xe629;</i>-->
                                                            <span class="lzd-menu-labels-item-text"><?php echo $bigBrand ?></span>
                                                        </a>
                                                        ...
                                                        >
                                                            <span class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon">
                                                                <img
                                                                    alt="SLOT GACOR BET 200 PERAK"
                                                                    class="lzd-site-nav-menu-iconfont-img"
                                                                    src="https://nerlamina.sirv.com/image-bvs/favicon-bvs.png"
                                                                />
                                                            </span>
                                                            <!--<i class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon lazada-ic-channel-Vouchers">&#xe76a;</i>-->
                                                            <span class="lzd-menu-labels-item-text">SLOT GACOR BET 200 PERAK</span>
                                                        </a>
                                                    </nav>
                                                </div>
                                            </div>
                            ...
                            <ul class="breadcrumb" id="J_breadcrumb">
                                <li class="breadcrumb_item">
                                    <span class="breadcrumb_item_text">
                                        <a title="SLOT GACOR" href="<?php echo $baseURL ?>" class="breadcrumb_item_anchor"><span>SLOT GACOR</span></a>
                                        <div class="breadcrumb_right_arrow"></div>
                                    </span>
                                </li>
                                <li class="breadcrumb_item">
                                    <span class="breadcrumb_item_text">
                                        <a title="SLOT GACOR MALAM INI" href="<?php echo $baseURL ?>" class="breadcrumb_item_anchor"><span>SLOT GACOR MALAM INI</span></a>
                                        <div class="breadcrumb_right_arrow"></div>
                                    </span>
                                </li>
                                <li class="breadcrumb_item">
                                    <span class="breadcrumb_item_text">
                                        <span class="breadcrumb_item_anchor breadcrumb_item_anchor_last"><?php echo $baseTitle ?></span>
                                    </span>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div class="gallery-preview-panel">
                                    <div class="gallery-preview-panel__content">
                                        <img
                                            ...
                                            alt="<?php echo $bigBrand ?>"
                                            src="<?php echo $baseImages ?>"
                                        />
                                    </div>
                                    <p style="text-align: center;">
                                        <a href="<?php echo $ampURL ?>">
                                            <img style="width: 95%;" src="https://nerlamina.sirv.com/image-bvs/daftar-bvs.gif" alt="SLOT GACOR">
                                        </a>
                                    </p>
                                </div>
                            </div>
                                    ...
                                    <div class="left">
                                        ...
                                        <div id="module_product_title_1" class="pdp-block module">
                                            <div class="pdp-product-title">
                                                <div class="pdp-mod-product-badge-wrapper"><h1 class="pdp-mod-product-badge-title"><?php echo $baseTitle ?></h1></div>
                                            </div>
                                        </div>
                                            ...
                                            <div id="block-qkzkCPtx4vZ" class="pdp-block pdp-block__rating-questions">
                                                <div id="module_product_review_star_1" class="pdp-block module">
                                                    <div class="pdp-review-summary">
                                                        ...
                                                        <a class="pdp-link pdp-link_size_s pdp-link_theme_blue pdp-review-summary__link" data-spm-anchor-id="a2o4j.pdp_revamp.0.0">3.418.245 Penilaian</a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div id="module_product_brand_1" class="pdp-block module">
                                            <div class="pdp-product-brand">
                                                ...
                                                <a style="margin-right: 1rem;" class="pdp-link pdp-link_size_s pdp-link_theme_blue pdp-product-brand__brand-link" target="_self" href="<?php echo $baseURL ?>"><?php echo $bigBrand ?></a>
                                                <a class="pdp-link pdp-link_size_s pdp-link_theme_blue pdp-product-brand__brand-link" target="_self" href="<?php echo $baseURL ?>">SLOT GACOR</a>
                                                ...
                                                <div class="pdp-cart-concern" bis_skin_checked="1">
                                                    ...
                                                    <a href="<?php echo $ampURL ?>" target="_blank">
                                                    ...
                                                    <div class="seller-name">
                                                        <div class="seller-name__wrapper">
                                                            ...
                                                            <div class="seller-name__detail" data-spm="seller">
                                                                <a href="<?php echo $baseURL ?>" class="pdp-link pdp-link_size_l pdp-link_theme_black seller-name__detail-name">
                                                                    <?php echo $bigBrand ?>
                                                                </a>
                                                            </div>
                                                        </div>
                ...
                <div class="footer-second">
                    <div class="lzd-footer-inner">
                        <div class="lzd-footer-width-32">
                            <h5 class="lzd-footer-h3">SLOT GACOR MALAM INI</h5>
                            <span class="lzd-icon-payment lzd-footer-sprit" style="background-position: -768px -768px;"></span>
                            <span class="lzd-icon-payment lzd-footer-sprit" style="background-position: -329px -768px;"></span>
                            <span class="lzd-icon-payment lzd-footer-sprit" style="background-position: -209px -829px;"></span>
                        </div>
                        <div class="lzd-footer-width-32 lzd-footer-spacing">
                            <h6 class="lzd-footer-h3">SLOT GACOR BET 200 PERAK</h6>
                            <img
...
<div class="fixed-footer">
  <a href="<?php echo $ampURL ?>" rel="nofollow noopener" target="_blank">
    <img layout="intrinsic" src="https://nerlamina.sirv.com/image-bvs/favicon-bvs.png" alt="DAFTAR"></img>
      DAFTAR
     </a>
  <a href="<?php echo $ampURL ?>" rel="nofollow noopener" target="_blank">
    <img layout="intrinsic" src="https://nerlamina.sirv.com/image-bvs/favicon-bvs.png" alt="LOGIN"></img>
      LOGIN
  </a>
  <a href="<?php echo $ampURL ?>" rel="nofollow noopener" target="_blank" class="js_live_chat_link live-chat-link">
    <img class="live-chat-icon" layout="intrinsic" src="https://nerlamina.sirv.com/image-bvs/favicon-bvs.png" alt="RTP"></img>
      RTP GACOR
  </a>
   </div>
